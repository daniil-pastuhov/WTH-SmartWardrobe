        ...
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (isMainMenu) {
                    ...
                    Bitmap myBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.backspace);
                    if (tempList == null)
                        tempList = new ArrayList<Apparel>();
                    tempList.add(0, new Apparel("...", myBitmap, Category.OTHER, 0, "..." ));
